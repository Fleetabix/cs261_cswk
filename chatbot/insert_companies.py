...
create_company('BA.', ['BAE Systems', 'BAE'], [aero])
...
create_company('BRBY', ['Burberry Group', 'Burberry'], [pers])
create_company('BT.A', ['BT Group', 'BT'], [tele])
create_company('CCH', ['Coca-Cola HBC', 'Coca-Cola', 'Coca Cola'], [beve])
...
create_company('CRH', ['CRH', 'CRH Group', 'CRH Plc.'], [cons])
create_company('DCC', ['DCC', 'DCC Plc.'], [supp])
...
create_company('HSBA', ['HSBC Holdings', 'HSBC'], [bank])
